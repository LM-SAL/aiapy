...
# and 2022 at a cadence of 180 days. We choose the 335 Å channel because it has experienced
# significant degradation compared to the other EUV channels.

results = Fido.search(
    a.Time("2010-06-01T00:00:00", "2022-01-01T00:00:00"),
    a.Sample(180 * u.day),
...
# These are needed to allow the use of astropy quantities and
